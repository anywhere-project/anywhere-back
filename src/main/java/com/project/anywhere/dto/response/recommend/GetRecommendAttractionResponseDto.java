...
@Getter
public class GetRecommendAttractionResponseDto extends ResponseDto {
    ...
    public GetRecommendAttractionResponseDto(RecommendAttractionEntity attractionEntity) {
    ...
    public static ResponseEntity<GetRecommendAttractionResponseDto> success(RecommendAttractionEntity attractionEntity) {
        GetRecommendAttractionResponseDto responseBody = new GetRecommendAttractionResponseDto(attractionEntity);
